package net.mcreator.jiojoi.client.gui;
...
public class FritoseScreen extends AbstractContainerScreen<FritoseMenu> {
	private final static HashMap<String, Object> guistate = FritoseMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	Button button_fry;

	public FritoseScreen(FritoseMenu container, Inventory inventory, Component text) {
