...
import net.mcreator.jiojoi.item.GoldchainItem;
...
import net.mcreator.jiojoi.item.DiparItem;
...
public class SurfinbirdModItems {
	public static final DeferredRegister<Item> REGISTRY = DeferredRegister.create(ForgeRegistries.ITEMS, SurfinbirdMod.MODID);
	...
	public static final RegistryObject<Item> MICROPLASTICK = block(SurfinbirdModBlocks.MICROPLASTICK);
	...
	public static final RegistryObject<Item> BAUMWOLLE = block(SurfinbirdModBlocks.BAUMWOLLE);
	...
	public static final RegistryObject<Item> STEEL_ORE = block(SurfinbirdModBlocks.STEEL_ORE);
	public static final RegistryObject<Item> STEEL_BLOCK = block(SurfinbirdModBlocks.STEEL_BLOCK);
	...
	public static final RegistryObject<Item> GOLDCHAIN = REGISTRY.register("goldchain", () -> new GoldchainItem());
	public static final RegistryObject<Item> DIPAR = REGISTRY.register("dipar", () -> new DiparItem());
