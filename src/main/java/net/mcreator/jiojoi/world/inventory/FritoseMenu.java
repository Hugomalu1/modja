...
package net.mcreator.jiojoi.world.inventory;
...
public class FritoseMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FritoseMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 43, 64) {
			private final int slot = 0;
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 43, 5) {
			private final int slot = 1;
		}));
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 61, 5) {
			private final int slot = 2;
		}));
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 43, 23) {
			private final int slot = 3;
		}));
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 61, 23) {
